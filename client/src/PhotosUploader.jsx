  ...
  function selectAsMainPhoto(ev,filename) {
    ...
    return(
        ...
        <div className="flex gap-2">
            ...
            <button
                className="bg-gray-200 px-4 rounded-2xl cursor-pointer"
            ...
            {addedPhotos?.length > 0 && addedPhotos.map(link => (
                <div key={link} className="h-32 flex relative">
                    <img
                        ...
                        src={link.startsWith('http') ? link : `http://localhost:4000/uploads/${link}`}
                        alt=""
                    />
                    ...
                    <button onClick={ev => selectAsMainPhoto(ev,link)} className='cursor-pointer absolute bottom-1 left-1 text-white bg-gray-900 bg-opacity-50 rounded-xl py-1 px-2'>
                      {link === addedPhotos[0] && (
